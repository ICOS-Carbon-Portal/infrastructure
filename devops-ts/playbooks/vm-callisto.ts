    ...
    tasks: [
      {
        ...
        iptables_raw: {
          ...
          table: "nat",
          rules:
            tmpl`-A PREROUTING -p tcp --dport ${filedrop_port} -j DNAT --to-destination 127.0.0.1:${filedrop_port}`,
        },
      },
    ],
  },
