...
export default [
  {
    ...
    block: [
      ...
      },
      {
        ...
        file: {
          path: tmpl("{{ _home_dir.stdout }}/.ssh"),
          state: "directory",
          mode: 0o700,
        },
        register: "_ssh_dir",
      },
      {
        ...
        copy: {
          ...
          dest: tmpl("{{ _ssh_dir.path}}/flexpart.rsa"),
          mode: 0o600,
        },
        register: "_rsa_file",
      },
      {
        ...
        known_hosts: {
          path: tmpl("{{ _ssh_dir.path }}/known_hosts"),
          name: tmpl("{{ flexpart_ssh_remote_host }}"),
          key: tmpl(
      ...
      },
      {
        ...
        blockinfile: {
          create: true,
          path: tmpl("{{ _ssh_dir.path }}/config"),
          mode: 0o600,
