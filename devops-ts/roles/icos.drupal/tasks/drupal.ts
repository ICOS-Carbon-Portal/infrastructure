...
import { isDefined, ne, truthy } from "../../../lib/vars.ts";
...
export default [
  ...
  },
  {
    ...
    command:
      tmpl`docker exec ${website}_drupal_1 stat -c '%U' /var/www/private/`,
  ...
  },
  {
    ...
    command:
      tmpl`docker exec ${website}_drupal_1 chown -R www-data:www-data /var/www/private/`,
  ...
  },
  {
    ...
    command:
      tmpl`docker exec ${website}_drupal_1 chown -R www-data:www-data /var/www/html/sites/default/files`,
