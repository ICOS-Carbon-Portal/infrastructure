...
export default {
  "all": {
    "vars": {
      ...
      "cpmeta_rdfstorage_path": tmpl("{{ cities_datafast_path }}/rdfStorage"),
    ...
    "children": {
      ...
      "core_server": {
        ...
        "vars": {
          ...
          "coreapp_host_ip": tmpl("{{ cities_lxd_ip }}"),
          ...
          "restheart_basic_auth": tmpl("{{ city_restheart_basic_auth }}"),
          "restheart_domains": [
            tmpl("{{ restheart_cities_domain }}"),
          ],
        },
      },
    },
