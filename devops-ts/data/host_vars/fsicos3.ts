// Auto-generated by gen-data.ts from ../devops/host_vars/fsicos3.yml
...
export default {
  ...
  "icosdata_nfs_mounts": [
    ...
    },
    {
      ...
      "src":
        "fsicos2.nebula:/disk/data/nextcloud/data/__groupfolders/27/WP1/Data",
      "opts": "ro,soft,x-systemd.after=zfs-mount.service",
    },
    {
      "path": "/pool/jupyter/project/icos_cities/fileshare/WP2_Data",
      "src":
        "fsicos2.nebula:/disk/data/nextcloud/data/__groupfolders/27/WP2/Data",
      "opts": "ro,soft,x-systemd.after=zfs-mount.service",
    },
    {
      "path": "/pool/jupyter/project/icos_cities/fileshare/WP3_Data",
      "src":
        "fsicos2.nebula:/disk/data/nextcloud/data/__groupfolders/27/WP3/Data",
      "opts": "ro,soft,x-systemd.after=zfs-mount.service",
    },
    {
      "path": "/pool/jupyter/project/icos_cities/fileshare/WP4_Data",
      "src":
        "fsicos2.nebula:/disk/data/nextcloud/data/__groupfolders/27/WP4/Data",
      "opts": "ro,soft,x-systemd.after=zfs-mount.service",
    },
    {
    ...
    },
    {
      "path": "/nfs/fluxcom_eo",
      "src":
        "fsicos2.nebula:/disk/data/nextcloud/data/__groupfolders/14/Data/FLUXCOM",
      "opts": "ro,soft,x-systemd.after=zfs-mount.service",
    },
    {
