  ...
  "all": {
    "vars": {
      ...
      "cpauth_domains": [
        ...
        tmpl("{{ cpauth_sites_domain }}"),
        tmpl("{{ cpauth_cities_domain }}"),
      ],
      "cpmeta_domains": [
        tmpl("{{ cpmeta_icos_domain }}"),
        tmpl("{{ cpmeta_sites_domain }}"),
        tmpl("{{ cpmeta_cities_domain }}"),
      ],
      "cpdata_domains": [
        tmpl("{{ cpdata_icos_domain }}"),
        tmpl("{{ cpdata_sites_domain }}"),
        tmpl("{{ cpdata_cities_domain }}"),
      ],
      "doi_domains": [
    ...
    "children": {
      ...
      "core_server": {
        ...
        "vars": {
          ...
          "coreapp_host_ip": tmpl("{{ staging_lxd_ip }}"),
