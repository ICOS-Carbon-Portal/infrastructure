...
import type { Vars } from "../../../../roles/icos.sshlogin/_ctx.ts";
...
export default {
  ...
  "_sshlogin_opt_list": [
    ...
    tmpl`${jinja`{% if ${V.sshlogin_dst_from} == 'srcip' -%}`} from="${V.sshlogin_src_ip}" ${jinja`{%- elif ${V.sshlogin_dst_from} -%}`} from="${V.sshlogin_dst_from}" ${jinja`{%- endif -%}`}`,
