...
import { nginxforward_cert, nginxforward_name } from "../../../../lib/paramvars.ts";
...
export default {
  ...
  "nginxforward_path_available": tmpl`/etc/nginx/sites-available/${nginxforward_name}.conf`,
  "nginxforward_path_enabled": tmpl`/etc/nginx/sites-enabled/${nginxforward_name}.conf`,
...
`,
  "nginxforward_user_file": tmpl`/etc/nginx/passwords/${nginxforward_name}.pass`
} satisfies Vars;
