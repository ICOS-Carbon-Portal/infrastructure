...
import type { Vars } from "../../../../roles/icos.utils/_ctx.ts";
...
export default {
  ...
  "ncdu_url":
    tmpl`https://dev.yorhel.nl/download/ncdu-${V.ncdu_version}-linux-${
      V.ncdu_arch_map.at(V.ansible_architecture)
    }.tar.gz`,
  "fd_architecture": V.fake_architecture.default(V.ansible_architecture),
  ...
  "watchexec_architecture": V.fake_architecture.default(V.ansible_architecture),
  ...
  "lazygit_upgrade": V.upgrade_everything.default(false).bool(),
  "lazygit_architecture": V.fake_architecture.default(V.ansible_architecture),
