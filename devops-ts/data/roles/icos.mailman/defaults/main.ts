...
export default {
  ...
  "mailman_volume_core": tmpl`${expr("mailman_home")}/volumes/core`,
  "mailman_volume_web": tmpl`${expr("mailman_home")}/volumes/web`,
  "mailman_volume_database": tmpl`${expr("mailman_home")}/volumes/database`,
  "mailman_build_core": tmpl`${expr("mailman_home")}/build/core`,
  "mailman_build_web": tmpl`${expr("mailman_home")}/build/web`,
  "mailman_django_settings": tmpl`${
    expr("mailman_volume_web")
  }/settings_local.py`,
  ...
  "mailman_postfix_config": [
    ...
    },
    {
      ...
      "value": tmpl`regexp:${
        expr("mailman_volume_core")
      }/var/data/postfix_lmtp`,
      "append": true,
    },
    {
    ...
    },
    {
      ...
      "value": tmpl`regexp:${
        expr("mailman_volume_core")
      }/var/data/postfix_domains`,
      "append": true,
    },
    {
      "param": "mynetworks",
      "value": expr("mailman_core_ipv4"),
      "append": true,
    },
    {
      "param": "mynetworks",
      "value": expr("mailman_web_ipv4"),
      "append": true,
    },
  ],
