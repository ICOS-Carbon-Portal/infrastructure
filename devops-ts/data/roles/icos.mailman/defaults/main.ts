...
import { vault_mailman_admin_email, vault_mailman_hyperkitty_api_key, vault_mailman_postgres_password, vault_mailman_web_secret_key } from "../../../../lib/vaultvars.ts";
...
export default {
  ...
  "mailman_serve_from_domain": jinja`{{ ${mailman_domains} | mandatory | first}}`,
