...
export default {
  ...
  "mailman_serve_from_domain": tmpl("{{ mailman_domains | mandatory | first}}"),
  "mailman_postgres_password": tmpl("{{ vault_mailman_postgres_password }}"),
  "mailman_hyperkitty_api_key": tmpl("{{ vault_mailman_hyperkitty_api_key }}"),
  "mailman_web_secret_key": tmpl("{{ vault_mailman_web_secret_key }}"),
  "mailman_admin_email": tmpl("{{ vault_mailman_admin_email }}"),
  ...
  "mailman_postfix_config": [
    ...
    {
      "param": "mynetworks",
      "value": tmpl("{{ mailman_core_ipv4 }}"),
      "append": true,
    },
    {
      "param": "mynetworks",
      "value": tmpl("{{ mailman_web_ipv4 }}"),
      "append": true,
    },
  ],
