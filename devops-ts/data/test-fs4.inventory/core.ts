...
import { cpauth_icos_domain, cpdata_icos_domain, cpmeta_icos_domain, fsicos4_ip, postgis_cities_db_name, postgis_icos_db_name, postgis_sites_db_name, restheart_cities_db_name, restheart_icos_db_name, restheart_sites_db_name } from "../../lib/globals.ts";
      ...
      "core_host": {
        ...
        "vars": {
          ...
          "cpauth_envries": [
            ...
            {
              "name": "ICOSCities",
              "restheart_url": tmpl`http://127.0.0.1:${restheart_bind_port}/${restheart_cities_db_name}`,
