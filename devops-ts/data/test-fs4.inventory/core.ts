          ...
          "cpauth_envries": [
            {
              "name": "ICOS",
              "restheart_url":
                tmpl`http://127.0.0.1:${restheart_bind_port}/${restheart_icos_db_name}`,
            },
            {
              "name": "SITES",
              "restheart_url":
                tmpl`http://127.0.0.1:${restheart_bind_port}/${restheart_sites_db_name}`,
            },
            {
              "name": "ICOSCities",
              "restheart_url":
                tmpl`http://127.0.0.1:${restheart_bind_port}/${restheart_cities_db_name}`,
