...
in  [
    ...
    in  [
      ...
      roles = let Role =
        ...
        , nginxforward_name : Optional Text
        , nginxforward_host : Optional Text
        , nginxforward_port : Optional Natural
        , nginxforward_cert : Optional Text
        , nginxforward_domains : Optional (List Text)
        ...
        , jbuild_users : Optional Text
        , jbuild_registry_pass : Optional Text
        , jbuild_edctl_host : Optional Text
        , jbuild_edctl_host_name : Optional Text
        , jbuild_edctl_host_port : Optional Natural
        , jbuild_rsync_host : Optional Text
        , jbuild_rsync_host_port : Optional Natural
        , jbuild_rsync_host_name : Optional Text
        , jbuild_jyctl_host : Optional Text
        , jbuild_jyctl_host_port : Optional Natural
        , jbuild_jyctl_host_name : Optional Text
      }
        , default =
  ...
  , Play::{
    ...
    in  [
      ...
      , Role::{ role = "icos.docker", tags = "docker", docker_periodic_cleanup = Some True }
      , Role::{
          role = "icos.jupyter",
          tags = "jupyter",
