-- Auto-generated from ../../devops/production.inventory/nebula.yml

{
    nebula_hosts = {
      vars = {
        nebula_interfaces = { interfaces = { `wg-*` = False } }
      , nebula_host = "0.0.0.0"
    ...
    , hosts = {
      ...
      , fsicos2 = { nebula_ip = "100.100.4.4", nebula_is_lighthouse = True }
      , fsicos3 = { nebula_ip = "100.100.4.2", nebula_is_lighthouse = True }
      , fsicos4 = {
          nebula_ip = "100.100.4.1"
        , nebula_is_lighthouse = True
        , nebula_fw_enable = False
      }
      , cdb = { nebula_ip = "100.100.4.7", nebula_is_lighthouse = True, nebula_fw_enable = True }
      , cupcake = { nebula_ip = "100.100.4.3", nebula_port = 60703 }
      , `fsicos4-stiltcluster` = { nebula_ip = "100.100.4.8", nebula_port = 60705 }
      , pancake = { nebula_ip = "100.100.4.9", nebula_port = 60706 }
    }
  }
}
