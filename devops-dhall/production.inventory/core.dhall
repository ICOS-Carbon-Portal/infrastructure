-- Auto-generated from ../../devops/production.inventory/core.yml

{
    all = {
      ...
      , cpmeta_domains = [ "{{ cpmeta_icos_domain }}", "{{ cpmeta_sites_domain }}" ]
      , cpdata_domains = [ "{{ cpdata_icos_domain }}", "{{ cpdata_sites_domain }}" ]
      , doi_domains = [ "doi.icos-cp.eu" ]
      , stiltweb_domains = [ "stilt.icos-cp.eu" ]
    ...
    , children = {
        ...
        , vars = {
          ...
          , cpmeta_config_files = [ "application_production.conf", "application_production_sensitive.conf" ]
          ...
          , cpauth_config_files = [ "application_production.conf" ]
      ...
      , core_server = {
        ...
        , vars = {
          ...
          , restheart_domains = [ "restheart.icos-cp.eu" ]
          , restheart_dbs = [ "{{ restheart_icos_db_name }}", "{{ restheart_sites_db_name }}" ]
