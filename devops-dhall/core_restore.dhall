-- Auto-generated from ../devops/core_restore.yml
...
in  [
    ...
    , tasks = [
        Task::{
          name = Some "Make sure borg is installed",
          tags = Some [ "setup" ],
          import_role = Some (Task.Poly_import_role.Record { name = "icos.borg", tasks_from = None Text })
        }
      , Task::{
          name = Some "Restore rdflog backup",
          tags = Some [ "rdflog" ],
          import_role = Some (Task.Poly_import_role.Record { name = "icos.postgresql", tasks_from = Some "restore.yml" }),
          vars = Some {
      ...
      , Task::{
          name = Some "Restore postgis backup",
          tags = Some [ "postgis" ],
          import_role = Some (Task.Poly_import_role.Record { name = "icos.postgresql", tasks_from = Some "restore.yml" }),
          vars = Some {
            postgresql_backup_host = Some "{{ corebackup_host }}",
      ...
      , Task::{
          ...
          tags = Some [ "restheart" ],
          import_role = Some (Task.Poly_import_role.Record { name = "icos.restheart", tasks_from = Some "restore.yml" }),
          vars = Some {
