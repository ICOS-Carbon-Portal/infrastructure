-- Auto-generated from ../../../../devops/roles/icos.dataold/tasks/main.yml
...
in  [
  ...
  , Task::{
      ...
      loop = Some (Task.Poly_loop.Texts [ "docker-compose.yml", "dataold.conf" ])
    }
  , Task::{
      ...
      loop = Some (Task.Poly_loop.Texts [ "openssl.cnf" ])
    }
  , Task::{
