...
in  [
    Task::{
      name = Some "Create basic auth users for \"testing\"",
      include_role = Some {
        name = "icos.nginxauth"
      ...
      , nginxauth_users = Some "{{ nginx_testing_users }}"
      ...
      when = Some [ "nginx_testing_users is defined" ]
    }
]
