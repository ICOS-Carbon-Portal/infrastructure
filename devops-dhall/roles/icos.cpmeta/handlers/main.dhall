-- Auto-generated from ../../../../devops/roles/icos.cpmeta/handlers/main.yml

let Task = ../../../types/Task.dhall

in  [
    Task::{
      name = Some "restart cpmeta",
    ...
    in  [
        Entry::{
          name = Some "Tell cpmeta to switch to readonly mode",
          uri = Some {
      ...
      , Entry::{
          name = Some "restart the cpmeta systemd service",
          systemd = Some { name = "cpmeta", state = Some "restarted" }
        }
    ])
    }
]
