...
in  [
    Task::{ import_tasks = Some "setup.yml", tags = Some [ "cpmeta_setup" ] }
  , Task::{
      import_tasks = Some "deploy.yml",
      tags = Some [ "cpmeta_deploy" ],
      when = Some [ "cpmeta_jar_file is defined" ]
    }
  , Task::{
      import_tasks = Some "restart.yml",
      tags = Some [ "cpmeta_restart" ],
      vars = Some {
