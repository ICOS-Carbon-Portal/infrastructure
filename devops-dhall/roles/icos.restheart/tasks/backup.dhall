-- Auto-generated from ../../../../devops/roles/icos.restheart/tasks/backup.yml
...
in  [
    Task::{
      ...
      vars = Some {
        ...
        where = None Text,
        state = None Text,
        bbclient_name = Some "{{ restheart_bbclient_name }}",
        bbclient_user = Some "root",
        bbclient_home = Some "{{ restheart_home }}/bbclient",
        bbclient_timer_conf = Some "OnCalendar=00/6:36",
