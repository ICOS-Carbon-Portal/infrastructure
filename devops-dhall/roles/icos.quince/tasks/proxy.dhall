-- Auto-generated from ../../../../devops/roles/icos.quince/tasks/proxy.yml
...
in  [
    Task::{
      ...
      vars = Some {
        ...
        nginxsite_name = Some "{{ quince_name }}",
        ...
        nginxsite_file = Some "quince.conf",
        ...
        nginxsite_domains = Some [ "{{ quince_domains }}" ],
