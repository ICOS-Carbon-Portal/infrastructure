-- Auto-generated from ../../../../devops/roles/icos.postgresql/tasks/pg_stat.yml
...
in  [
    ...
    in  [
        Entry::{
          name = Some "Add pg_stat_statements to postgresql shared_preload_libraries",
          register = Some "_set",
          `community.postgresql.postgresql_set` = Some { name = "shared_preload_libraries", value = "pg_stat_statements" }
        }
    ])
    }
  , Task::{
