-- Auto-generated from ../../../../devops/roles/icos.zrepl/tasks/config.yml
...
in  [
    ...
    in  [
        Task::{
          name = Some "Create zrepl.yaml",
          register = Some "update",
          copy = Some {
            content = Some "{{ zrepl_config }}"
    ...
    in  [
      ...
      , Task::{ name = "Validation failed", fail = Some { msg = "Error in config.yaml" } }
    ]),
