-- Auto-generated from ../../../../devops/roles/icos.mailman/defaults/main.yml

{
  ...
  , mailman_postfix_config = let Item =
      { Type =
          { param : Text
      , value : Text
  ...
  in  [
      Item::{ param = "recipient_delimiter", value = "+" }
    , Item::{ param = "unknown_local_recipient_reject_code", value = "550" }
    , Item::{ param = "owner_request_special", value = "no" }
    , Item::{
    ...
    , Item::{ param = "mynetworks", value = "{{ mailman_core_ipv4 }}", append = Some True }
    , Item::{ param = "mynetworks", value = "{{ mailman_web_ipv4 }}", append = Some True }
  ]
  , mailman_rest_user = "restadmin"
  , mailman_rest_port = 8001
  , mailman_rest_allow_deny = None Text
