-- Auto-generated from ../../../../devops/roles/icos.typesense/tasks/main.yml
...
in  [
  ...
  , Entry::{
      ...
      block = Some (let Item =
        { Type =
            { name : Optional Text
        , user : Optional ({ name : Text, state : Text })
        , file : Optional ({ path : Text, state : Text, recurse : Optional Bool, owner : Text, mode : Optional Text, modification_time : Optional Text, access_time : Optional Text })
        , template : Optional ({ src : Text, dest : Text, owner : Text })
        , `community.docker.docker_compose_v2` : Optional ({ project_src : Text, state : Text, pull : Text })
        , include_role : Optional ({ name : Text })
        , vars : Optional ({ nginxsite_name : Optional Text, nginxsite_file : Optional Text, nginxsite_domains : Optional (List Text), timer_user : Optional Text, timer_home : Optional Text, timer_name : Optional Text, timer_conf : Optional Text, timer_content : Optional Text })
