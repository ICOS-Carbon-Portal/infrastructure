-- Auto-generated from ../../../../devops/roles/icos.geoip/tasks/main.yml

let Task = ../../../types/Task.dhall

in  [
    Task::{ import_tasks = Some "geoip_setup.yml", tags = Some [ "geoip_setup" ] }
  , Task::{ import_tasks = Some "geoip_app.yml", tags = Some [ "geoip_app" ] }
  , Task::{
      import_role = Some (Task.Poly_import_role.Str "name=icos.certbot2"),
      tags = Some [ "geoip_certbot" ]
    }
  , Task::{
      import_role = Some (Task.Poly_import_role.Str "name=icos.nginxsite"),
      tags = Some [ "geoip_nginx" ],
      vars = Some {
        ...
        nginxsite_domains = Some [ "{{ geoip_domain }}" ],
