...
in  [
    Task::{
      ...
      , timer_exec = Some "bash -c 'lxc query /1.0/metrics | sponge lxd.prom'"
      , timer_name = Some "node-exporter-lxd"
      , timer_conf = Some "OnCalendar=*:*:00,30"
      ...
      , dbin_path = None Text
      , dbin_arch = None Text
      , timer_wdir = Some "{{ node_exporter_textfiles }}"
