-- Auto-generated from ../../../../devops/roles/icos.node_exporter/tasks/vmagent.yml

let Task = ../../../types/Task.dhall

in  [
    Task::{
      name = Some "Retrieve bindmounts fact",
      tags = Some [ "conf" ],
      shellfact = Some {
  ...
  , Task::{
      ...
      vars = Some {
        ...
        vmagent_config_dest = Some "node-exporter-host.yaml",
