-- Auto-generated from ../../../../devops/roles/icos.bbclient2/tasks/single_repo.yml

let Task = ../../../types/Task.dhall

in  [
    Task::{
      name = Some "Read the public key",
      check_mode = Some False,
      slurpfact = Some { path = "{{ bbclient_ssh_key }}.pub", fact = "bbclient_key_data" }
    }
  , Task::{
      name = Some "Configure remote - bbserver - host",
  ...
  , Task::{
      name = Some "Configure local - bbclient - host",
