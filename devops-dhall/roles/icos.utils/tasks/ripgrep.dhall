-- Auto-generated from ../../../../devops/roles/icos.utils/tasks/ripgrep.yml
...
in  [
    ...
    in  [
        Entry::{
          name = Some "Find the latest release of ripgrep",
          register = Some "gh",
          github_release = Some { user = "BurntSushi", repo = "ripgrep", action = "latest_release" }
        }
      , Entry::{
          name = Some "Set ripgrep_version fact",
          set_fact = Some {
          ...
          , ripgrep_version = Some "{{ gh.tag.lstrip('v') }}"
  ...
  , Task::{
      ...
      apt = Some {
        ...
        upgrade = None Text,
        deb = Some "{{ ripgrep_url_map[ansible_architecture] }}",
        purge = None Bool,
        autoclean = None Bool,
  ...
  , Task::{
    ...
    in  [
        Task::{
          name = Some "Install ripgrep using apt",
          apt = Some {
            name = [ "ripgrep" ]
          , state = None Text
          , update_cache = None Bool
