-- Auto-generated from ../../../../devops/roles/icos.nebula/tasks/iptables.yml

let Task = ../../../types/Task.dhall

in  [
    Task::{
      when = Some [ "nebula_fw_enable" ],
      block = Some (let Task =
        { Type =
            { name : Optional Text
    ...
    in  [
      ...
      , Task::{
          name = Some "Allow nebula through firewall",
          iptables = Some {
            state = "absent"
          , chain = "INPUT"
          , protocol = Some "udp"
      ...
      , Task::{
          name = Some "Allow all traffic on nebula interface",
          iptables = Some {
            state = "absent"
          , chain = "INPUT"
          , protocol = None Text
  ...
  , Task::{
      when = Some [ "not nebula_fw_enable" ],
