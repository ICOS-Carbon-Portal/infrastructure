-- Auto-generated from ../../../../devops/roles/icos.nebula/tasks/cert.yml
...
in  [
  ...
  , Task::{
    ...
    in  [
      ...
      , Task::{
          name = Some "Sign pubkey to create certificate",
      ...
      , Task::{
          name = Some "Write signed certificate",
          copy = Some {
            content = Some "{{ signedcert.stdout }}"
