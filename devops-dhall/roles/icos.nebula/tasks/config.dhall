-- Auto-generated from ../../../../devops/roles/icos.nebula/tasks/config.yml
...
in  [
    ...
    in  [
        Entry::{
          name = Some "Copy nebula_config.yml",
    ...
    in  [
      ...
      , Task::{ name = "Fail", fail = Some { msg = "Nebula config file is broken" } }
    ]),
