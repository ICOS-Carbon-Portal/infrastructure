-- Auto-generated from ../../../../devops/roles/icos.nebula/tasks/download.yml
...
in  [
    ...
    in  [
        Entry::{
          name = Some "Find the latest release of nebula",
          register = Some "gh",
          github_release = Some { user = "slackhq", repo = "nebula", action = "latest_release" }
        }
      , Entry::{
          name = Some "Set nebula_version fact",
          set_fact = Some {
          ...
          , nebula_version = Some "{{ gh.tag.lstrip('v') }}"
