-- Auto-generated from ../../../../devops/roles/icos.just/tasks/install.yml
...
in  [
  ...
  , Task::{
      ...
      register = Some "_r",
      failed_when = Some (Task.Poly_failed_when.Str "not _r.stdout.endswith(just_version)")
    }
  , Task::{
      name = Some "Which version of just was installed",
      debug = Some (Task.Poly_debug.Record { msg = "Installed {{ just_version }}" })
    }
]
