-- Auto-generated from ../../../../devops/roles/icos.cpauth/tasks/backup.yml
...
in  [
    Task::{
      ...
      vars = Some {
        ...
        where = None Text,
        state = None Text,
        bbclient_name = Some "cpauth",
        bbclient_user = Some "{{ cpauth_user }}",
        bbclient_home = Some "{{ cpauth_home }}/.bbclient",
