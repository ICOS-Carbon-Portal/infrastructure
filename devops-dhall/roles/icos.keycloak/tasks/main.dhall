-- Auto-generated from ../../../../devops/roles/icos.keycloak/tasks/main.yml
...
in  [
      ...
      loop = Some (Task.Poly_loop.Records [
          {
            ...
            dest = Some "{{ kc_home }}/docker-compose.yml",
            name = None Text,
            mode = None Text,
            key = None Text,
            val = None Text,
        ...
        , {
            ...
            line = None Text,
            regex = None Text,
            src = Some "keycloak.conf",
            dest = Some "{{ kc_home }}/conf/keycloak.conf",
            name = None Text,
            mode = None Text,
            key = None Text,
            val = None Text,
  ...
  , Task::{
      ...
      docker_compose = Some {
        project_src = "{{ kc_home }}",
        build = None Bool,
        restarted = Some "{{ _config.changed }}",
        state = None Text
    }
    }
  , Task::{
      ...
      vars = Some {
        ...
        nginxsite_file = Some "keycloak-nginx.conf",
        ...
        nginxsite_domains = Some [ "{{ kc_hostname }}" ],
