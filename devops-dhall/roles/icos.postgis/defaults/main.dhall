-- Auto-generated from ../../../../devops/roles/icos.postgis/defaults/main.yml

{
  ...
  , postgis_db_users = [
      { username = "reader", password = "{{ postgis_reader_pass }}" }
    , { username = "writer", password = "{{ postgis_writer_pass }}" }
  ]
  , postgis_dbs = [
