-- Auto-generated from ../../../../devops/roles/icos.nextcloud/tasks/nginx.yml
...
in  [
    Task::{
      ...
      when = Some [ "nextcloud_certbot_enable" ]
    }
  , Task::{
    ...
    in  [
        Entry::{
          name = Some "Copy nextcloud-nginx.conf",
    ...
    in  [
      ...
      , Entry::{ name = "Flush handlers", meta = Some "flush_handlers" }
    ])
    }
]
