-- Auto-generated from ../devops/prom-nextcloud.yml
...
in  [
    ...
    , tasks = [
        Task::{
          name = Some "Add nextcloud to vmagent",
          tags = Some [ "nextcloud" ],
          include_role = Some (Task.Poly_include_role.Record {
              apply = Some { tags = "nextcloud" },
              name = "icos.vmagent",
              tasks_from = Some "add_fsd",
              public = None Bool
          }),
          vars = Some {
            ...
            fsd_name = Some "nextcloud",
            fsd_target = Some "localhost:9205",
